export function AdminHeaderStats({ totalCourses, morningShiftsCount, avgCost }) {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
      ...
      <div className="p-6 rounded-3xl bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 shadow-md flex items-center gap-4">
        ...
        <div>
          <span className="block text-2xl font-black text-gray-900 dark:text-white">{morningShiftsCount}</span>
          <span className="text-xs text-gray-500 dark:text-gray-400 font-medium">Cursos Matutinos</span>
        </div>
      </div>
